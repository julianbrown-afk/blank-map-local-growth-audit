(function () {
  ...
  const STARTER_PROSPECTS = [
    ...
    },
    {
      ...
      reviewStatus: "Source and mobile check completed; no outreach sent",
      reviewedOn: "2026-07-02",
      safeNextAction: "Use only in warm or permitted scorecard-first channels; anchor on booking assets, then ask whether proof, tracking, and follow-up support the appointment path.",
      status: "Lead",
      sourceLinks: [
        "PROSPECT_REVIEW_PACKET.md",
    ...
    },
    {
      ...
      reviewStatus: "Source and mobile check completed; no outreach sent",
      reviewedOn: "2026-07-02",
      safeNextAction: "Recheck the accessibility panel state in a clean browser, then use only warm or permitted scorecard-first channels.",
      status: "Lead",
      sourceLinks: [
        "PROSPECT_REVIEW_PACKET.md",
    ...
    },
    {
      ...
      reviewStatus: "Source and mobile check completed; no outreach sent",
      reviewedOn: "2026-07-02",
      safeNextAction: "Use only in warm or permitted scorecard-first channels; anchor on the visible appointment path and proof-placement question.",
      status: "Lead",
      sourceLinks: [
        "PROSPECT_REVIEW_PACKET.md",
    ...
    },
    {
      ...
      businessType: "Med spa",
      website: "https://www.beautifulyoumedspa.com/",
      city: "Lexington",
      avgCustomerValue: 500,
      leadsNeeded: 10,
      ...
      reviewStatus: "Source and mobile check completed; no outreach sent",
      reviewedOn: "2026-07-02",
      safeNextAction: "Use only in warm or permitted scorecard-first channels; if a conversation opens, lead with mobile overflow, booking clarity, proof placement, and cookie-friction hypotheses.",
      status: "Lead",
      sourceLinks: [
        "PROSPECT_REVIEW_PACKET.md",
    ...
    },
    {
      ...
      reviewStatus: "Source and mobile check completed; no outreach sent",
      reviewedOn: "2026-07-02",
      safeNextAction: "Use only in warm or permitted scorecard-first channels; anchor on quote/estimate clarity, storm-damage intent, proof placement, tracking, and follow-up.",
      status: "Lead",
      sourceLinks: [
        "PROSPECT_REVIEW_PACKET.md",
    ...
    },
    {
      ...
      reviewStatus: "Source and mobile check completed; no outreach sent",
      reviewedOn: "2026-07-02",
      safeNextAction: "Use only in warm or permitted scorecard-first channels; confirm whether quote and certified-inspection paths are obvious without menu navigation.",
      status: "Lead",
      sourceLinks: [
        "PROSPECT_REVIEW_PACKET.md",
    ...
    },
    {
      ...
      reviewStatus: "Source and mobile check completed; no outreach sent",
      reviewedOn: "2026-07-02",
      safeNextAction: "Use only in warm or permitted scorecard-first channels; if a conversation opens, lead with mobile overflow, offscreen form/nav, quote clarity, proof placement, and tracking/follow-up questions.",
      status: "Lead",
      sourceLinks: [
        "PROSPECT_REVIEW_PACKET.md",
    ...
    },
    {
      ...
      reviewStatus: "Source and mobile check completed; no outreach sent",
      reviewedOn: "2026-07-02",
      safeNextAction: "Use only in warm or permitted scorecard-first channels; anchor on inspection CTA, cookie friction, first-screen proof, tracking, and follow-up questions.",
      status: "Lead",
      sourceLinks: [
        "PROSPECT_REVIEW_PACKET.md",
...
This is planning input, not a revenue guarantee.`;
  ...
  function buildFounderLaunchReply() {
    const settings = state.settings;
    const scorecardUrl = getPublicUrl("scorecard.html");
    const sampleUrl = getPublicUrl("sample-audit.html");
    const offerUrl = getPublicUrl();

    return `Thanks for taking a look. The lowest-pressure first step is the free buyer-path scorecard:
${scorecardUrl}
...
If the scorecard shows enough friction, the fixed-scope ${settings.serviceName} is ${currency(settings.auditPrice)} and turns the result into ranked findings, tracking notes, and a 30-day action plan:
${offerUrl}
