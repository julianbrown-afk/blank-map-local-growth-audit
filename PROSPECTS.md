# Initial Lexington Prospect List

Research date: 2026-07-02

Status: research only. No outreach has been sent. The first fifteen dentist, med spa, and roofing prospects have internal review notes in `REVIEWED_PIPELINE.csv`.
...
These categories are good fits because a single new customer can be valuable enough to justify a `$399` audit:
...
| Business | Category | Website | Why review it |
| --- | --- | --- | --- |
| Park Hills Family Dentistry | Dentist | https://parkhillsfamilydentistry.com/ | Review booking path, new-patient flow, review presentation, and mobile clarity. |
| Cooper Family Dentistry | Dentist | https://www.cooperfamilydental.com/ | Review how review proof, service pages, and call-to-action structure support new-patient conversion. |
| Tates Creek Dental | Dentist | https://www.tatescreekdental.com/reviews | Review review request flow, new-patient action, and conversion path from reviews to booking. |
| AMS Dental | Dentist | https://amsdentalcare.com/ | Review request-appointment flow, patient proof, and service clarity. |
| Complete Dentistry for All Ages | Dentist | https://www.completedentistrylexington.com/ | Review testimonial proof, appointment action, and mobile first-screen clarity. |
| Williams Family Dentistry | Dentist | https://jewilliamsdmd.com/ | Review testimonial visibility, booking action, and local search confidence signals. |
| Luxe Lounge Medspa | Med spa | https://www.luxeloungemedspa.com/ | Review treatment pages, consultation CTA, social proof, and booking friction. |
| Belle Vie Aesthetic Medicine | Med spa | https://bellevietoday.com/ | Review treatment proof, booking action, and service-area clarity. |
...
Use these defaults when adding a prospect unless the website clearly suggests better values:

| Category | Average customer value | Extra customers wanted |
| --- | ---: | ---: |
| Dentist | 650 | 8 |
| Med spa | 500 | 10 |
| Roofing | 4500 | 2 |
...
For each prospect, inspect:

- Is one primary booking, call, or quote action visible on mobile?
- Does the Google profile appear complete and current?
- Are reviews recent and easy to find?
- Does the website explain the highest-value service clearly?
- Is there a follow-up path for people who do not book immediately?
- Are calls, forms, and booking clicks plausibly trackable by source?
