...
- `index.html`: operator dashboard for pricing, prospect audits, daily outreach batches, niche offer links, outreach CSV export, pipeline tracking, report export, and config export.
